...
import com.example.shopify.databinding.FragmentFilterBinding;
...
//belaow is the framgment in which we ask user to choose filter in category, condition and price range
